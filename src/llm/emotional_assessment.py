...
if __name__ == "__main__":
    ...
    INPUT_RUN_FILE = "data/02_generated/outputs_Llama-2-7b-chat-hf_20251014_203636.jsonl"
    
    OUTPUT_DIR = "data/02_generated/assessments/"

    # Ruta de los cuestionarios
    ASSESSMENTS_FILE = "data/01_stimuli/assessments/emotion_assessments.json"
